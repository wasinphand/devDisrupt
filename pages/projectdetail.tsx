                ...
                <Flex bg="gray.50" width="30vw" align="flex-top" justify="center">
                    <Stack spacing={8} mt="5vh">
                        <Box px={8} width="100%" mb={2} mx="auto">
                            ...
                            <Box>
                                <Button my={2} width="100%" variantColor="green">
                                    ติดต่อโครงการ
                </Button>
                            </Box>
                            <Box mt={5}>
                            ...
                            <Box>
                                ...
                                <FormControl id="card-num" isRequired>
                                    <FormLabel>หมายเลขบัตร</FormLabel>
                                </FormControl>
                                <Input placeholder="xxxxxxxxxx" />
                                <FormControl id="card-name" isRequired>
                                ...
                                <Box>
                                    <Box mt={3} rounded="10px" bg="white" w="100%" p={4} >
                                        <Text color="black" fontSize="18px">สิ่งของที่รับบริจาค / สนับสนุน</Text>
                                        <List spacing={1} mt={1}>
                                            <ListItem>
                                                <ListIcon icon="info" color="green.500" />
                                                อาหารว่างสำหรับนักเรียน
                                            </ListItem>
                                            <ListItem>
                                                <ListIcon icon="info" color="green.500" />
